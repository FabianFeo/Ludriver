...
class LuPreocupada extends StatefulWidget {
  LuPreocupada({Key key}) : super(key: key);

  @override
  _LuPreocupadaState createState() => _LuPreocupadaState();
}

class _LuPreocupadaState extends State<LuPreocupada> {
  double height = 0;
  double width = 0;
  @override
