...
import 'package:luconductora/src/widgets/verificationButton.dart';
...
class EstoyAqui extends StatefulWidget {
  ...
  @override
  EstoyAquiState createState() => EstoyAquiState();
}

class EstoyAquiState extends State<EstoyAqui> {
  /// Service injection
    ...
    if (faceDetected == null) {
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(content: Text('No face detected!'));
          });
